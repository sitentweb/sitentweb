            ...
            children: [
                ...
                child: Column(
                    children: [
                        SupportDetails(
                          ...
                          icon: Icons.email,
                          onTap: () async {
                              var email = "mailto:info@remarkable.com";
                              await canLaunch(email) ? launch(email) : print("Can't Launch This");
                          },
                          ),
                        SizedBox(height: 15,),
                        SupportDetails(
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Text("Developed by Sitent Web" , style:GoogleFonts.poppins(
    ...
    return Row(
      children: [
        ...
        Expanded(
          ...
          child: InkWell(
            onTap: onTap,
            child: Icon(icon , color: kDarkColor,),
          )
        )
        ],
    );
