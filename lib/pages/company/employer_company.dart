          ...
          builder: (context, snapshot) {
             if(snapshot.hasData){
               if(snapshot.data.status){
                              ...
                              children: [
                                Container(
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 10,),
                                      Expanded(
                                        child: Text("${company.companyName}" , style: GoogleFonts.poppins(
                                ...
                                Container(
                                  child: Row(
                                    children: [
                                      SizedBox(width: 10,),
                                      Expanded(child: Text("${company.companyDes}" , style: GoogleFonts.poppins(), overflow: TextOverflow.ellipsis,))
                                    ],
                                  ),
                                ),
                                SizedBox(height: 10,),
                                Container(
                                  child: Row(
                                    children: [
                                      Icon(Icons.location_pin , size: 20, color: kDarkColor ),
                                      SizedBox(width: 5,),
                                      Expanded(child: Text("${company.companyAddress}")),
                                    ],
                                  ),
                                ),
                                SizedBox(height: 10,),
                                Container(
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 5,),
                                      Expanded(child: Text("${company.companyWebsite}")),
                                    ],
                                  ),
                                ),
                                SizedBox(height: 10,),
                                Container(
                                  child: Row(
                                    children: [
                                      Icon(Icons.history , size: 20, color: kDarkColor ),
                                      SizedBox(width: 5,),
                                      Expanded(child: Text(timeAgo.format(company.createdOn))),
                                    ],
                                  ),
                                )
                              ],
                 ...
                 return EmptyData(message: "No Company Here, Please Post Job to create company");
               }
