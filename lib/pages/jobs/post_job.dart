    ...
    await EducationApi().fetchEducation().then((educations) {
      educations.data.forEach((education) {
        _tempEdu.add(DropdownMenuItem(
          child: Text("${education.educationName}" , style: GoogleFonts.poppins(
            color: Colors.black
          ),),
    ...
    await IndustryApi().fetchIndustries().then((industries) {
      industries.data.forEach((industry) {
        _tempInd.add(DropdownMenuItem(
            child: Text("${industry.industryTitle}" , style: GoogleFonts.poppins(
                color: Colors.black
            )),
          ...
          child: ListView(
            ...
            children: [
              Container(
                  ...
                  child: Text("Post New Job" , style: GoogleFonts.poppins(
                    fontSize: 18,
              ...
              DropdownButtonFormField(
                ...
                hint: Text("Select Job Type" , style: GoogleFonts.poppins(fontSize: 14),),
                items: [
                  DropdownMenuItem(child: Text("Part Time") , value: "Part Time",),
                  DropdownMenuItem(child: Text("Full time") , value: "Full Time",),
                  DropdownMenuItem(child: Text("Work From Home") , value: "Work From Home",)
                ],
                onChanged: (value) {
                  setState(() {
              ...
              SizedBox(height: 5,),
              ListTile(
                title: Text("Min Experience" , style: GoogleFonts.poppins(fontSize: 14),),
                trailing: GestureDetector(
                  onTap: () {

                    final _formKey = GlobalKey<FormState>();

                    TextEditingController _experienceIn = TextEditingController();
                    TextEditingController _experienceYear = TextEditingController();
                    TextEditingController _experienceMonth = TextEditingController();
                          ...
                          return AlertDialog(
                            actions: [
                                Row(
                                  ...
                                  children: [
                                    Text("Experience Details" , style: GoogleFonts.poppins(fontSize: 14 , fontWeight: FontWeight.bold)),
                                  ],
                                ),
                                Container(
                                          ...
                                          children: [
                                            ...
                                            MaterialButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                "ExperienceTitle" : _experienceIn.text,
                                                "ExperienceYear" : _experienceYear.text,
                                                "ExperienceMonth" : _experienceMonth.text
                                                }));
                                                setState(() {
                  ...
                  child: Text("+Add Experience" , style: GoogleFonts.poppins(
                    fontSize: 13,
                    color: kDarkColor
                  ),),
                ),
                ...
                child: Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Row(
                        children: [
                          Text(exp['ExperienceTitle'] , style: GoogleFonts.poppins(
                            color: Colors.white
                          ),),
                          Spacer(),
                          Text("${exp['ExperienceYear']} Yrs, ${exp['ExperienceMonth']} Mon" , style: GoogleFonts.poppins(
                            color: Colors.white
                          ),),
                          SizedBox(width: 5,),
                          GestureDetector(
                ...
                children: [
                  MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      fetchUserCompanies = CompanyApi().fetchUserCompanies(userID);
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              return Padding(
                                                ...
                                                child: ListTile(
                                                  ...
                                                  await CompanyApi().fetchCompanyByID(company.companyId.toString()).then((value) {

                                                  print(value.data.companyId);
                                                  Provider.of<SelectCompanyNotifier>(context , listen: false).select(
                                                  value.data.companyId.toString(), true, true, value.data
                                                  );
                                                  ...
                                                  leading: CircleAvatar(
                                                    radius: 20,
                                                    backgroundColor: Colors.white,
                                                    backgroundImage: AppSetting.showUserImage(company.companyLogo),
                                                  ),
                                                ),
                                              );
                                            },
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.radio_button_checked_rounded , size: 12,),
                        SizedBox(width: 3,),
                        Text("Choose Company" , style: GoogleFonts.poppins(
                          fontSize: 12
                        ),)
                      ],
                    ),
                  ...
                  MaterialButton(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 3,),
                        Text("Create Company" , style: GoogleFonts.poppins(
                          fontSize: 12
                        ),)
                      ],
                    ),
              ...
              //Selected Company Card
                Consumer<SelectCompanyNotifier>(
                    builder: (context, value, child) {
                      ...
                      return value.companySelected ? Padding(
                        padding: EdgeInsets.all(8),
                        child: Card(
                          child: Column(
                            children: [
                                  ...
                                  children: [
                                    AvatarGlow(
                                        ...
                                        child: CircleAvatar(
                                          radius: 15,
                                          backgroundColor: Colors.white,
                                          backgroundImage: AppSetting.showUserImage(value.companyData.companyLogo ?? ""),
                                        ),
                                        endRadius: 24
                                    ),
                                    SizedBox(width: 5,),
                                    Expanded(
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              Text("${value.companyData.companyName}" ,
                                                style: GoogleFonts.poppins(
                                                    fontWeight: FontWeight.bold
                                                ),
                                              ...
                                              Container(
                                                ...
                                                child: Text("${value.companyData.companyAddress}" , style: GoogleFonts.poppins(
                                                    color: Colors.grey
                                                ),),
                                              )
                                            ],
              ...
              !_isJobPosting ? MaterialButton(onPressed: () async {
                if(_companySelected){
                  print("go ahead for posting");
                  setState(() {
                    _isJobPosting = true;
                  });
                  ...
                  var jobData = jsonEncode({
                    ...
                    "job_details" : {
                      ...
                      "job_qualification" : _qualificationController.text,
                      ...
                      "job_ext_experience" : jsonDecode(_experiences.toString()),
                  ...
                  await PostJobApi().postJob(jobData).then((value) {
                    if(value.status){
                      ...
                      var snackBar = SnackBar(content: Text("Job Posted Successfully"),);
