...
//
//     final saveJobsListModel = saveJobsListModelFromJson(jsonString);

import 'dart:convert';

SaveJobsListModel saveJobsListModelFromJson(String str) => SaveJobsListModel.fromJson(json.decode(str));

String saveJobsListModelToJson(SaveJobsListModel data) => json.encode(data.toJson());

class SaveJobsListModel {
  SaveJobsListModel({
    this.status,
    this.data,
  });
  ...
  factory SaveJobsListModel.fromJson(Map<String, dynamic> json) => SaveJobsListModel(
    status: json["status"],
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    savejobsId: json["savejobs_id"],
    jobId: json["job_id"],
    userId: json["user_id"],
    saveOn: DateTime.parse(json["save_on"]),
  ...
  Map<String, dynamic> toJson() => {
    "savejobs_id": savejobsId,
    "job_id": jobId,
    "user_id": userId,
    "save_on": saveOn.toIso8601String(),
