...
FetchHiredCandidatesModel fetchHiredCandidatesModelFromJson(String str) => FetchHiredCandidatesModel.fromJson(json.decode(str));

String fetchHiredCandidatesModelToJson(FetchHiredCandidatesModel data) => json.encode(data.toJson());
...
class FetchHiredCandidatesModel {
  ...
  factory FetchHiredCandidatesModel.fromJson(Map<String, dynamic> json) => FetchHiredCandidatesModel(
    status: json["status"],
