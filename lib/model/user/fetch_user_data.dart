...
//
//     final fetchUserDataModel = fetchUserDataModelFromJson(jsonString);

import 'dart:convert';

FetchUserDataModel fetchUserDataModelFromJson(String str) => FetchUserDataModel.fromJson(json.decode(str));

String fetchUserDataModelToJson(FetchUserDataModel data) => json.encode(data.toJson());
...
class FetchUserDataModel {
  ...
  factory FetchUserDataModel.fromJson(Map<String, dynamic> json) => FetchUserDataModel(
    status: json["status"],
