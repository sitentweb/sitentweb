...
class GetAllInterviewsApi {
  ...
  Future<GetAllInterviewModel> getAllInterviews(userID , userType) async {
    ...
    try{
      ...
      final response = await client.get(Uri.parse(getAllScheduleInterview + "?user_id="+userID+"&user_type="+userType));
  ...
  Future sendInterviewSession(interviewID , sessionData , userType) async {
    ...
    try{
      ...
      final response = await client.post(Uri.parse(base_url+'/sendInterviewSession') , body : {
  ...
  Future getInterviewSession(interviewID) async {
    ...
    try{
      ...
      final response = await client.get(Uri.parse(base_url+"/getInterviewSession?interview_id="+interviewID));
  ...
  Future<GlobalStatusModel> createInterview(employeeID, employerID, interviewTitle, interviewTime, interviewType) async {
    ...
    try{
       ...
       final response =  await client.post(Uri.parse(createInterviewApiUrl) , body: {
  ...
  Future<GlobalStatusModel> interviewResponse(interviewID, interviewStatus) async {
    GlobalStatusModel thisResponse = GlobalStatusModel();
    ...
    try{
      ...
      final response = await Dio().get(interviewResponseApiUrl , queryParameters: {
        "interview_id" : interviewID,
